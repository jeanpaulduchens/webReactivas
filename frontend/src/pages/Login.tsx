      ...
      >
        ...
        <div className="relative w-[420px] bg-white rounded-2xl shadow-lg p-6 z-[2]">
          ...
          <form onSubmit={handleLogin}>
            ...
            <label className="text-xs font-bold text-muted mb-1.5 block mt-3">
              Contraseña
            </label>
          ...
          <p className="text-muted text-xs text-center mt-3">
            ¿Olvidaste tu contraseña? <a href="#!">Restablecer aquí</a>
            <br />
          ...
          <button className="btn login-back" onClick={() => navigate(-1)}>
            ← Volver
          </button>
        </div>
      </div>
