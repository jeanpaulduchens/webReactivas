...
export default function Register() {
  ...
  return (
    <div>
      <h2 className="text-lg font-extrabold my-[18px] mx-0">BarberBook - Registro</h2>
      ...
      <div className="min-h-[70vh] grid place-items-center relative rounded-card overflow-hidden" style={{backgroundImage: "url('https://images.unsplash.com/photo-1582095133179-bfd08e2fc6b3?q=80&w=1800&auto=format&fit=crop')", backgroundSize: 'cover', backgroundPosition: 'center'}}>
        ...
        <div className="relative w-[420px] bg-white rounded-2xl shadow-lg p-6 z-[2]">
          ...
          <div className="font-extrabold text-2xl my-2 text-center">Registrar Nueva Cuenta</div>
          ...
          <form onSubmit={handleRegister} className="space-y-3">
            ...
            <div>
              <label className="text-xs font-bold text-muted mb-1.5 block">Nombre Completo</label>
              <input
                className="w-full h-10 border border-gray-200 rounded-[10px] px-3 bg-white outline-none focus:border-indigo-300 focus:shadow-[0_0_0_3px_#e0e7ff] disabled:opacity-60"
            ...
            <div>
              <label className="text-xs font-bold text-muted mb-1.5 block">Email</label>
              <input
                className="w-full h-10 border border-gray-200 rounded-[10px] px-3 bg-white outline-none focus:border-indigo-300 focus:shadow-[0_0_0_3px_#e0e7ff] disabled:opacity-60"
                type="email"
            ...
            <div>
              <label className="text-xs font-bold text-muted mb-1.5 block">Teléfono</label>
              <input
                className="w-full h-10 border border-gray-200 rounded-[10px] px-3 bg-white outline-none focus:border-indigo-300 focus:shadow-[0_0_0_3px_#e0e7ff] disabled:opacity-60"
                type="tel"
            ...
            <div>
              <label className="text-xs font-bold text-muted mb-1.5 block">Contraseña</label>
            ...
            <div>
              <label className="text-xs font-bold text-muted mb-1.5 block">Confirmar Contraseña</label>
              <div className="relative">
                <input
                  className="w-full h-10 border border-gray-200 rounded-[10px] px-3 bg-white outline-none focus:border-indigo-300 focus:shadow-[0_0_0_3px_#e0e7ff] disabled:opacity-60"
